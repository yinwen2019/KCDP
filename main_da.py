...
def get_args_parser():
    ...
    parser.add_argument('--bert-model', default='/home/user/xxx/PLM/bert-base-uncased', type=str)
    ...
    # * Finetuning params
    parser.add_argument('--visfinetune', default='weights/pvt_small.pth', help='finetune from checkpoint')
    parser.add_argument('--finetune', default='', help='finetune from checkpoint')

    # Dataset parameters
    parser.add_argument('--dataset', default='SER_6',
                        choices=['SER_6', 'Emoset'], type=str)
    ...
    parser.add_argument('--output_dir', default='checkpoints/SER',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='checkpoints/SER/checkpoint_best_Emoset.pth', help='resume from checkpoint')
...
def main(args):
    ...
    if True:  # args.distributed:
        ...
        if args.dist_eval:
            ...
            sampler_val = torch.utils.data.RandomSampler(dataset_val, num_samples=10000)
    else:
    ...
    if args.eval:
        v_file = '/home/user/xxx/MultiModal/TGCA_PVT/tsne/S2E_TGCA_ser_v_100.csv'
        with open(v_file, mode='w', newline='') as file:
            writer = csv.writer(file)
            writer.writerow([f'feature_{i}' for i in range(6)])

        l_file = '/home/user/xxx/MultiModal/TGCA_PVT/tsne/S2E_TGCA_ser_l_100.csv'
